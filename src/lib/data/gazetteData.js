export const headerData = {
  ...
  breakingTicker: "BREAKING: REGISTRATION NOW OPEN — PREMIER HACKATHON AT G.H. RAISONI COLLEGE — ₹25,000 PRIZE POOL — 12 HOURS OF PURE INNOVATION — LIMIT 50 TEAMS — SECURE YOUR STATION NOW —",
  navLinks: [
...
export const heroData = {
  headline: "In Pursuit of Structural Digital Integrity",
  leadParas: [
    "In the heart of India's geographic center, a new digital dawn rises. CODE FORGE 2026 isn't merely a competition; it is a gathering of the finest minds tasked with hand-crafting the next generation of infrastructure.",
    "This inaugural event challenges participants to transcend the ephemeral. We seek architectures that exhibit the resilience of tempered steel and the precision of a master watchmaker. Join us in Nagpur for an odyssey of pure creation."
  ],
  figureImg: "https://lh3.googleusercontent.com/aida/AP1WRLvIIRv_ifIBCgi9U2FIctBJh_mINR1CqefHmW6IgomrjQnSLF3Odv8b72vhl1Ovs7qpNTqhBzLvokm-HP10a1YHtlanVaGkj5R-fN17bZEkkyjUzHVil4QJl6nkwXRlgyasqGT1OHuIM5KNa5kBh9_gRCRTnQVhDHc0mL7F7ba5BQdHj1x0VdHDYY3cmpdJ26xmE1xGK1AFXeAUoDEwkkIRcRwOMCQZ6l04dGoSCAqdJ408uz9h4tRFT8Zd",
  figureCaption: "Fig 01: The Central Engine. ARCHIVE 2026. A documentation of the core processing unit designed for high-integrity protocol execution.",
  metrics: [
