...
<footer class="bg-[#FAF6EE] pt-8 pb-8 mt-6 border-t-8 border-double border-primary select-none w-full">
  ...
  <div class="w-full px-4 md:px-8 flex flex-col items-center text-center">
    ...
    <div class="w-full border-4 border-double border-primary p-6 md:p-8 bg-[#FAF6EE] text-primary shadow-[4px_4px_0px_rgba(43,43,42,0.15)] rounded-sm my-2 font-mono relative">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-8 w-full mb-6 font-mono text-xs uppercase tracking-widest border-b border-primary/40 pb-6">
        <!-- Affiliations -->
        ...
        <div class="flex flex-col items-center pt-2 md:pt-0">
          ...
          <div class="flex flex-col items-center gap-2">
            ...
            >
              <svg class="w-4 h-4 fill-current group-hover:scale-105 transition-transform" viewBox="0 0 24 24">
